...
class InitialBlock(nn.Layer):
    ...
    def __init__(self,
        ...
        self.batch_norm = nn.BatchNorm2D(out_channels, momentum=0.1)
    ...
    def __init__(self,
        ...
        self.ext_conv1 = nn.Sequential(
            nn.Conv2D(
                ...
                kernel_size=1,
                stride=1,
                bias_attr=bias_attr), nn.BatchNorm2D(internal_channels, momentum=0.1), activation)
        ...
        self.ext_conv3 = nn.Sequential(
            nn.Conv2D(
                ...
                kernel_size=1,
                stride=1,
                bias_attr=bias_attr), nn.BatchNorm2D(channels, momentum=0.1), activation)
    ...
    def __init__(self,
        ...
        self.ext_conv3 = nn.Sequential(
            nn.Conv2D(
                ...
                kernel_size=1,
                stride=1,
                bias_attr=bias_attr), nn.BatchNorm2D(out_channels, momentum=0.1), activation)
...
class UpsamplingBottleneck(nn.Layer):
    ...
    def __init__(self,
        ...
        self.main_conv1 = nn.Sequential(
            nn.Conv2D(in_channels, out_channels, kernel_size=1, bias_attr=bias_attr),
        ...
        self.ext_conv1 = nn.Sequential(
            nn.Conv2D(
                in_channels, internal_channels, kernel_size=1, bias_attr=bias_attr),
            nn.BatchNorm2D(internal_channels, momentum=0.1), activation)
        ...
        self.ext_conv3 = nn.Sequential(
            nn.Conv2D(
                internal_channels, out_channels, kernel_size=1, bias_attr=bias_attr),
            nn.BatchNorm2D(out_channels, momentum=0.1), activation)
...
class ENet(nn.Layer):
    ...
    def __init__(self, n_class, encoder_relu=False, decoder_relu=True):
